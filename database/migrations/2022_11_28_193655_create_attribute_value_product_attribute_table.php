...
class CreateAttributeValueProductAttributeTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('attribute_value_product_attribute', function (Blueprint $table) {
            ...
            $table->unsignedInteger('attribute_value_id')->references('id')->on('attribute_values');
            // $table->foreign('attribute_value_id')->references('id')->on('attribute_values');
            $table->unsignedInteger('product_attribute_id')->references('id')->on('attribute_values');
